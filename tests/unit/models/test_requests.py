...
class TestConfigOverrides:
    ...
    def test_invalid_llm_max_tokens(self):
        ...
        with pytest.raises(ValidationError, match="Input should be less than or equal to 8000"):
    ...
    def test_too_many_exclude_patterns(self):
        ...
        with pytest.raises(ValidationError, match="Too many exclude patterns \\(max 50\\)"):
...
class TestFileContent:
    ...
    def test_invalid_content_too_large(self):
        ...
        with pytest.raises(ValidationError, match="File content too large \\(max 1MB\\)"):
...
class TestAnalysisRequest:
    ...
    def test_duplicate_filenames(self):
        ...
        files = [
            ...
            FileContent(filename="test.py", content="print('world')")  # Duplicate filename
        ]
...
class TestAnalysisFromPathRequest:
    def test_valid_path_analysis_request(self):
        ...
        request = AnalysisFromPathRequest(
            paths=["/path/to/code", "/path/to/other"],
            recursive=False,
            verbose=True
        )

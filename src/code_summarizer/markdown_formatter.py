...
class MarkdownFormatter:
    ...
    def format_results(self, files_data: List[Dict[str, Any]], 
...
*Generated on {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}*"""
    ...
    def _format_overview(self, project_info: Dict[str, Any], 
                        analysis_results: List[Dict[str, Any]]) -> str:
        """Format overview section"""
        languages_str = ', '.join(project_info['languages']) if project_info['languages'] else 'Unknown'

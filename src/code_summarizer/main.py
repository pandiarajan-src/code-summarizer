...
@click.option('--config', '-c', type=click.Path(exists=True), default='config.yaml', help='Configuration file path')
@click.option('--verbose', '-v', is_flag=True, help='Enable verbose output')
def analyze(input_path, output, config, verbose):
    """
    ...
    try:
        ...
        markdown_content = markdown_formatter.format_results(files_data, analysis_results)
